...
<body>
    ...
    <div class="container py-5">
        ...
        if (!isset($_GET['id']) || empty($_GET['id'])) {
            ...
            $api_url_seance = "http://localhost:3000/api/films/{$film_id}/seances";

            // Récupérer les données de l'API
            $response = file_get_contents($api_url);
            $response_seance = file_get_contents($api_url_seance);
            ...
            if ($response === false ) {
                ...
                $data_seance = json_decode($response_seance, true);

                // Vérifier si le film existe
                if (isset($data['data']) && !empty($data['data'])) {
                    $film = $data['data'];
                    $seances=$data_seance['data'];
        ?>
                    <div class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div id="seances-container" class="container mt-5">
                                <h2>Les séances disponibles</h2>
                                <!-- Les séances seront affichées ici -->
                                <?php foreach ($seances as $seance): ?>
                                    <p><strong>Places disponibles :</strong> <?php echo $seance['places_disponibles']; ?></p>
                                    <div class="row">
                                        <p class="col-md-2"><strong>Date :</strong> <?php echo $seance['date']; ?></p>
                                        <p class="col-md-2"><strong>Heure :</strong> <?php echo $seance['heure']; ?></p>
                                    </div>
                                    <hr>
                                <?php endforeach ?>
                            </div>
